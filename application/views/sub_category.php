						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									{
									?>
                                    <form method="post" action="<?php echo site_url('quiz/insert_sub_category'); ?>">
									<h1>CATEGORY : </h1> <br><input type="text" name="category" value="<?php echo $row->category; ?>"><br><br><?php  		$id=$row->id;
									$_SESSION['id']=$id;
									}
									?>
                                    <h1>ADD SUB-CATEGORY : </h1> <br><input type="text" name="sub_category"><br><br>
